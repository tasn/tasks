...
public class Migrations {
  ...
  private static final Migration MIGRATION_70_71 =
      new Migration(70, 71) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
          database.execSQL("ALTER TABLE `caldav_account` ADD COLUMN `encryption_password` TEXT");
          database.execSQL("ALTER TABLE `caldav_account` ADD COLUMN `cda_auth_token` TEXT");
          database.execSQL(
